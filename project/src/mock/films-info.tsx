...
const filmsInfo: Film[] = [
  ...
  },
  {
    ...
    description: 'In an effort to thwart Grindelwald&aposs plans of raising pure-blood wizards to rule over all non-magical beings, Albus Dumbledore enlists his former student Newt Scamander, who agrees to help, though he&aposs unaware of the dangers that lie ahead. Lines are drawn as love and loyalty are tested, even among the truest friends and family, in an increasingly divided wizarding world.',
    rating: 3.4,
    scoresCount: 160757,
  ...
  },
  {
    ...
    description: 'A father and son go on the run, pursued by the government and a cult drawn to the childc&apos special powers.',
    rating: 3.3,
    scoresCount: 67815,
  ...
  },
  {
    ...
    description: 'A biopic depicting the early years of legendary Director and aviator Howard Hughes&apos career from the late 1920s to the mid 1940s.',
    rating: 9.8,
    scoresCount: 307174,
    director: 'Martin Scorsese',
    starring: [
  ...
  },
  {
    ...
    description: 'Kevin&aposs mother struggles to love her strange child, despite the increasingly dangerous things he says and does as he grows up. But Kevin is just getting started, and his final act will be beyond anything anyone imagined.',
    rating: 3.8,
    scoresCount: 123240,
  ...
  },
  {
    ...
    description: 'A year after their father&aposs funeral, three brothers travel across India by train in an attempt to bond with each other.',
    rating: 3.6,
    scoresCount: 165106,
    director: 'Wes Anderson',
    starring: [
  ...
  },
  {
    ...
    description: 'After a sudden attack on the MI5, Johnny English, Britain&aposs most confident yet unintelligent spy, becomes Britain&aposs only spy.',
    rating: 10,
    scoresCount: 136843,
